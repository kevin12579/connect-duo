# 오픈마켓 <img src="frontend/src/connect_duo/assets/connectDuo_logo.png" width="120" alt="ConnectDuo Logo"/>
...
- Bootstrap, jQuery (mixitup UI/애니메이션)
- Axios (API 통신)
...
| 이름   | 역할                                                |
| ------ | --------------------------------------------------- |
| 박성훈 | 팀장, 시스템 설계, AI/LLM 챗봇, 채팅·백엔드·DB 설계 |
| 김수형 | 시장 분석, 데이터 조사, 요구분석·기획               |
| 방세정 | UI/UX 디자인, 프론트 개발, 발표자료(PPT)            |
| 신창희 | 프론트 개발, 기능 점검, 테스트                      |
